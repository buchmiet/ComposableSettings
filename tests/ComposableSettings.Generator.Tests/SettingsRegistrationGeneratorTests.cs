...
public  class SettingsRegistrationGeneratorTests(ITestOutputHelper output) : GeneratorBaseClass(output)
{
    [Fact]
    ...
    public void Component_without_settings_type_is_not_registered()
    {
        var (diagnostics, generatedSources) = CompileAndRunAllGenerators("""
                                                                         ...
                                                                         public  class NoSettingsViewModel { }
                                                                         """);
